...
import { resendOtpCall, sendOtp, userSignup, validateOtp } from '../../../api/UserRequest'
...
function UserSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      //     position: 'top-end',
      //     icon: 'success',
      //     title: 'Signup Sucess,Please Login...',
  ...
  return (
    <div>
      <div className={`w-full h-screen flex ${otpModal? 'opacity-80':'' } `}>
                ...
                <div class='w-full outline-none focus:outline-none'>
                  <div class='bg-blue-500 h-64 py-3 rounded text-center relative'>
                    ...
                    <div class='flex justify-center text-center mt-5'>
                      <p class='flex items-center text-blue-700 hover:text-blue-900 cursor-pointer'>
